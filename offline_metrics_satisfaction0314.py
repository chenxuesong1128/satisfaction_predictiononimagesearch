                ...
                for row in results_dict[task_id][user][query_id]:
                    for result in results_dict[task_id][user][query_id][row]:
                        ...
                        for judgement in judgement_list:
                            ...
                            distribution_2d['all'][judgement][int(row)][column_index] += result[judgement]
                            distribution_2d[query_type_list[query_type_id]][judgement][row][column_index] += int(result[judgement])
